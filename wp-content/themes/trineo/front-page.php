    ...
    <div class="">
        <div class="container">
            <div class="row vertically-middle">
                <div class="home-header col-md-12 padding-xl-top padding-xl-bottom  wow fadeIn new-effect ">
...
?>
<section class="section section-2 padding-xl-top padding-lg-bottom visible-md starrybg" id="section2">
    <div class="container">
        ...
        <div class="container">
            <div class="row vertically-middle">
                <div class="col-md-4 padding-lg-bottom padding-xl-right " >
                    <div class="h3 wow fadeIn new-effect"><?php echo $section3_heading; ?></div>
                    <div class="hidden-md  wow fadeIn new-effect">
                ...
                <div class="col-md-8 padding-md-bottom">
                    <div class="row vertically-middle align-center">
                        ...
                        <div class="visible-md align-left wow fadeIn new-effect"
                             data-wow-delay="0.<?php echo $clientIndex; ?>s">
                            <a class="button button--white" href="/why-trineo/our-partners/">Explore More</a>
                        </div>
                    </div>
...
<div class="bg1b">
    <section class="section section-5 padding-xl-top padding-md-bottom purple-background">
        <div class="container">
            <div class="row vertically-middle2 wow fadeIn new-effect">
                <div class="col-md-4 padding-lg-bottom wow fadeIn new-effect">
                ...
                foreach ($repeater as $row) {
                    $index++;
                    ?>
                    <div class="col-md-3 col-icon-text padding-md-bottom  white-text padding-lg-top wow fadeIn new-effect"
                ...
                ?>
                <div class="visible-md align-left padding-md-bottom wow fadeIn new-effect"
                     data-wow-delay="0.<?php echo ++$clientIndex; ?>s">
                    <a class="button button--white"
                       href="<?php echo $section_5['section5_cta_link']; ?>"><?php echo $section_5['section5_cta_text']; ?></a>
                </div>
